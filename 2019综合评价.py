...
# 模拟浏览器访问
headers = {
    'User-Agent': 'Mozilla/5.0 (Linux; Android 8.1.0; Redmi 5 Build/OPM1.171019.026) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/68.0.3440.106 YaBrowser/18.9.1.2199.00 Mobile Safari/537.36',
...
def getcookie(n,p,headers):
    ...
    params={"systemId":1,"backUrl":"http://www.qgjypt.com/login_ja.html","username":n,"password":p,"type":1}
...
table=rxlsx(f)
num=0#第几个学生
url = '''http://sr.qgjypt.com/ewms/school/addOrUpdateGradeDate.action'''
