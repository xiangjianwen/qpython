...
def getcookie(n,p,headers):
    ...
    params={"systemId":1,"backUrl":"http://www.qgjypt.com/login_sr.html","username":n,"password":p,"type":3}
...
def getstudit(c,studentCode):#学籍号转删除stuId
    s=[]
    url="http://sr.qgjypt.com/enrollment/student_inf_qry.action"   
...
def delstudent(c,headers,stuId):
    url1="http://sr.qgjypt.com/enrollment/student_delete.action"
